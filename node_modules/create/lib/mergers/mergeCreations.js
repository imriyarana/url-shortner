...
export function mergeCreations(first, second) {
    return withoutUndefinedProperties({
        ...
        suggestions: applyMerger(first.suggestions, second.suggestions, mergeSuggestions),
    });
}
//# sourceMappingURL=mergeCreations.js.map