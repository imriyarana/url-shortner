...
describe("createNpxInstallationConfirm", () => {
    it("resolves with undefined without confirming if yes is true", async () => {
        ...
        const actual = await createNpxInstallationConfirm("../create-my-app", spinner, true)();
    ...
    it("resolves with an error if yes is false and the confirm prompt is not accepted", async () => {
        ...
        const actual = await createNpxInstallationConfirm("../create-my-app", spinner, false)();
...
//# sourceMappingURL=createNpxInstallationConfirm.test.js.map